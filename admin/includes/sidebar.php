<div class="sidebar-menu">
    <header class="logo">
        <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="dashboard.php"> <span id="logo"> <h1>Ms Plate BMS</h1></span>
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Profit Calculation</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="add-total-cost.php"> Add Buy</a></li>
                    <li id="menu-academico-boletim" ><a href="manage-personal-cost.php">Manage Profit</a></li>


                </ul>
            </li>
            <li><a href="add-product.php"><i class="fa fa-user"></i> <span>Add Product</span></a></li>
            <li><a href="manage-product.php"><i class="fa fa-table"></i> <span>Product List</span></a></li>
            <li><a href="invoices.php"><i class="fa fa-file-text-o"></i> <span>Profit View</span></a></li>
            <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Personal cost</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="add-total-cost.php"> Add cost</a></li>
                    <li id="menu-academico-boletim" ><a href="manage-personal-cost.php">Manage cost</a></li>
