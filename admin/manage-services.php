...
if (strlen($_SESSION['clientmsaid'] == 0)) {
    ...
    <html>
    <head>
        <title>MS Plate Business Management System || Manage Services </title>
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $row) { ?>
                                            <tr class="active">
                                                ...
                                                <td><a href="edit-services-details.php?editid=<?php echo $row->ID; ?>">Edit</a>
                                                </td>
                                            </tr>
                                            <?php $cnt = $cnt + 1;
                                        }
