...
$sql="update tblservices set ServiceName=:sname,ServicePrice=:price,quantity = :quantity where ID=:eid";
...
{               ?>
	...
	<div class="form-group"> <label for="exampleInputEmail1">Service Remaining</label> <input type="number" name="quantity" value="<?php echo $row->quantity;?>" class="form-control" required='true'> </div>
