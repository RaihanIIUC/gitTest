...
//        $query->bindParam(':totalsum',$totalsum,PDO::PARAM_STR);
    ...
    <html>
    <head>
        <title>Ms Plate Business Management Sysytem|| Add Sells History</title>
                ...
                <div class="outter-wp">
                    ...
                    <div class="sub-heard-part">
                        <ol class="breadcrumb m-b-0">
                            ...
                            <li class="active">Add Sells History</li>
                        </ol>
                    </div>
                    <!--/sub-heard-part-->
                    <!--/forms-->
                    <div class="forms-main">
                        <h2 class="inner-tittle">Add Sells History </h2>
                                        ...
                                        <div class="hk-pg-header">
                                            <h4 class="hk-pg-title"><span class="pg-title-icon"><span
                                                        class="feather-icon"><i
                                                            data-feather="external-link"></i></span></span>History</h4>
                                        </div>
                                        <!-- /Title -->
                                                            ...
                                                            <form class="needs-validation" method="post" novalidate>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col-md-6 mb-10">
                                                                        <label for="validationCustom031">Product Name</label>
                                                                        <input type="number" class="form-control"
                                                                               id="validationCustom031"
                                                                               placeholder="Please provide a valid Product Name" name="cost1"
                                                                               required>
                                                                        <div class="invalid-feedback"></div>
                                                                    </div>

                                                                    <div class="col-md-6 mb-10">
                                                                        <label for="validationCustom032">Kg</label>
                                                                        <input type="number" class="form-control"
                                                                    ...
                                                                    <div class="col-md-6 mb-10">
                                                                        <label for="validationCustom033">Price</label>
                                                                        <input type="number" class="form-control"
