...
if (strlen($_SESSION['clientmsaid'] == 0)) {
    ...
    <html>
    <head>
        <title>MS Plate Business Management System|| Change Password</title>
                        ...
                        <div class="graph-form">
                            <div class="form-body">
                                <form name="changepassword" method="post" onsubmit="return checkpass();" action="">
                                    ...
                                    <div class="form-group"><label for="exampleInputEmail1">Current Password</label>
                                    ...
                                    <div class="form-group"><label for="exampleInputEmail1">New Password</label> <input
                                                type="password" name="newpassword" class="form-control" required="true">
                                    </div>
                                    <div class="form-group"><label for="exampleInputEmail1">Confirm
                                            Password</label><input type="password" name="confirmpassword"
                                                                   id="confirmpassword" value="" class="form-control"
                                                                   required="true"></div>

                                    <button type="submit" class="btn btn-default" name="submit" id="submit">Change
                                    </button>
                                </form>
                            </div>
                        </div>
