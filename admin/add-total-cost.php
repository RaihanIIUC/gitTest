...
//        $query->bindParam(':totalsum',$totalsum,PDO::PARAM_STR);
    ...
    <html>
    <head>
        <title>Ms Plate Business Management Sysytem|| Add Clients</title>
                                        ...
                                        <div class="hk-pg-header">
                                            <h4 class="hk-pg-title"><span class="pg-title-icon"><span
                                                            class="feather-icon"><i
                                                                data-feather="external-link"></i></span></span>Add
                                                Company</h4>
                                        </div>
                                        <!-- /Title -->
                                                            ...
                                                            <form class="needs-validation" method="post" novalidate>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col-md-6 mb-10">
                                                                        <label for="validationCustom031">Todays
                                                                            Invest</label>
                                                                        <input type="number" class="form-control"
                                                                               id="validationCustom031"
                                                                               placeholder="Todays Invest" name="cost1"
                                                                               required>
                                                                    ...
                                                                    <div class="col-md-6 mb-10">
                                                                        <label for="validationCustom032">Todays
                                                                            Sales</label>
                                                                        <input type="number" class="form-control"
                                                                               id="validationCustom032"
                                                                               placeholder="Todays Sales" name="cost2"
                                                                               required>
                                                                        <div class="invalid-feedback">Please provide a
                                                                            valid Sales amount.
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-6 mb-10">
                                                                        <label for="validationCustom033">Todays
                                                                            Cost</label>
                                                                        <input type="number" class="form-control"
                                                                               id="validationCustom033"
                                                                               placeholder="Todays Cost" name="cost3"
                                                                               required>
                                                                        <div class="invalid-feedback">Please provide a
                                                                            valid Todays Cost.
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-6 mb-10">
                                                                        <label for="validationCustom033">Description( Cause )</label>
                                                                        <textarea class="form-control"
                                                                               id="validationCustom033"
                                                                               placeholder="Cause" name="cost4"  rows="2" cols="20"
                                                                                  required ></textarea>
